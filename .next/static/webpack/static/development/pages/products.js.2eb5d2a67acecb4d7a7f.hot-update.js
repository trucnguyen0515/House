...
var ProductPage = /*#__PURE__*/function (_Component) {
  ...
  function ProductPage() {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "renderProducts_child", function (parr) {
      ...
      return itemsChild.map(function (res, i) {
        return itemsChild.length - 1 === i ? __jsx("div", {
          ...
          href: "".concat(_const_routes__WEBPACK_IMPORTED_MODULE_13__["default"].ProductDetail.href),
          as: "".concat(_const_routes__WEBPACK_IMPORTED_MODULE_13__["default"].ProductDetail.as(res.slug)),
          __source: {
            fileName: _jsxFileName,
            lineNumber: 58
          },
          ...
          __self: this
        }, res.name)), __jsx(next_link__WEBPACK_IMPORTED_MODULE_9___default.a, {
          href: "".concat(_const_routes__WEBPACK_IMPORTED_MODULE_13__["default"].ProductDetail.href),
          as: "".concat(_const_routes__WEBPACK_IMPORTED_MODULE_13__["default"].ProductDetail.as(parr.slug)),
          __source: {
            fileName: _jsxFileName,
            lineNumber: 61
          },
          ...
          __self: this
        }, "Show All ", parr.name, " ", __jsx(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_10__["FontAwesomeIcon"], {
          className: "ml-5",
          ...
          key: i,
          href: "".concat(_const_routes__WEBPACK_IMPORTED_MODULE_13__["default"].ProductDetail.as(res.slug)),
          __source: {
            fileName: _jsxFileName,
            lineNumber: 69
          },
      ...
      return _data_data__WEBPACK_IMPORTED_MODULE_12__["dataCategories"].map(function (res, i) {
        if (res.parent.length === 0) {
          return __jsx(antd__WEBPACK_IMPORTED_MODULE_8__["Col"], {
            ...
            __self: this
          }, _this.renderProducts_child(res))));
        }
...
//# sourceMappingURL=products.js.2eb5d2a67acecb4d7a7f.hot-update.js.map